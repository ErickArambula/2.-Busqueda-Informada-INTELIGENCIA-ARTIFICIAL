...
print("Usando A*:")
resultado_a_estrella = a_estrella(grafo_ejemplo, inicio, objetivo, heuristica)
if resultado_a_estrella:
    print(f"Camino más corto de {inicio} a {objetivo} usando A*: {resultado_a_estrella}")
else:
    print(f"No se encontró un camino de {inicio} a {objetivo} usando A*")

print("\nUsando AO*:")
resultado_ao_estrella = ao_estrella(grafo_ejemplo, inicio, objetivo, heuristica)
if resultado_ao_estrella:
    print(f"Camino más corto de {inicio} a {objetivo} usando AO*: {resultado_ao_estrella}")
else:
    print(f"No se encontró un camino de {inicio} a {objetivo} usando AO*")
